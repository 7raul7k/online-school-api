...
class EnrolmentResourceTest {
    ...
    public void addEnrolment() throws Exception {
        ...
        EnrolmentDTO enrolment = EnrolmentDTO.builder().studentFirstName(student.getFirstName()).studentLastName(student.getLastName()).studentEmail(student.getEmail()).courseName(course.getName()).build();
